...
window.onload = function() {
  document.querySelector("#btn").addEventListener("click", () => {
    const generadordeExc = document.querySelector("#excuse");
    generadordeExc.innerHTML = generadorExcusas();
  });
};

let generadorExcusas = function() {
  let titleHTML = "No me lo vas a creer, pero...";
  const tag = document.querySelector("#title1");
  tag.innerHTML = titleHTML;
